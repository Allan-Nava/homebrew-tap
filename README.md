...
brew install --cask robotsmith          # CLI
...
| `robotsmith` | [robotsmith](https://github.com/Allan-Nava/robotsmith) CLI — Verifies a robots.txt and advises how to write it from your real traffic | macOS `arm64`/`amd64`, Linux `arm64`/`amd64` |
...
brew uninstall --cask robotsmith
